...
lib/ ├── main.dart # Punto de entrada de la aplicación | ├── models/ │ └── tarea_model.dart # Modelo de datos para una Tarea | ├── providers/ │ └── tareas_provider.dart # Lógica de negocio y gestión del estado | ├── screens/ │ ├── login_screen.dart # Pantalla de inicio de sesión │ └── tareas_screen.dart # Pantalla principal que muestra la lista de tareas | └── widgets/ ├── filter_chips.dart # Widget para los chips de filtrado ├── new_task_fab.dart # Widget para el Floating Action Button ├── search_field.dart # Widget para el campo de búsqueda └── tarea_card.dart # Widget que muestra una tarea individual
