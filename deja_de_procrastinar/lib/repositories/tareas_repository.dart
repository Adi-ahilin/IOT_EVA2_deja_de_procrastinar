...
class TareasRepository {
  ...
  // Obtiene la colección de trámites del usuario
  CollectionReference getTareasCollection(String userId) {
    // CAMBIO CLAVE: Estructura ahora es users/{userId}/tramites
    return _firestore
        .collection('users')
        .doc(userId)
  ...
  // RF11: CREAR una nueva evaluación/trámite
  ...
  // RF12: ELIMINAR una evaluación/trámite
